...
export default async function ProductPage({
  ...
  return (
    <div className="container my-6 ml14">
      <div className="flex gap-16 items-center justify-between lg:ml-14">
        ...
        <div className="relative aspect-video w-full max-w-lg lg:flex-grow">
            <Image
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mt-8 items-start lg:ml-14">
  ...
  if (alreadyOwnsProduct) {
    ...
    return (
      <Button className="text-xl h-auto py-4 px-8 rounded-lg" asChild>
        <Link href={`https://wa.me/9779769884993`}>Get Now</Link>
      </Button>
    )
  }
}
...
//   const coupon = await getUserCoupon()
  if (price === 0)  {
    return <div className="text-xl">NRP {price}</div>
  }
